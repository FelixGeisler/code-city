...
const definitions = [
  ...
  ["top-level-import-mixed", "t.ts", "import { type A, B } from 'm';", "typescript"], ["top-level-export-mixed", "t.ts", "export { type A, B };", "typescript"], ["top-level-side-effect-import", "t.ts", "import 'm';", "typescript"], ["top-level-export-empty", "t.ts", "export {};", "typescript"],
