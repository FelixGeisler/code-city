...
export const DEMO_MODEL: CityModel = {
  ...
  solutions: [
    {
      ...
      name: "Code City",
      path: ".",
      moduleIds: ["module:viewer", "module:core"],
    },
  ],
  modules: [
    {
  ...
  buildings: [
    {
      ...
      repositoryId: "repository:demo",
      moduleId: "module:viewer",
      districtId: "district:viewer",
      name: "main.ts",
      path: "apps/viewer/src/main.ts",
      language: "typescript",
      metrics: {
        sloc: 248,
        decisionLoad: 28,
        maximumComplexity: 8,
        executableUnitCount: 24,
      },
      risk: "moderate",
      semanticGroupId: "group:viewer",
      position: { x: -11.5, y: 6, z: -1.8 },
      size: { x: 4, y: 10, z: 4 },
    },
    {
      ...
      moduleId: "module:viewer",
      districtId: "district:viewer",
      name: "model-validation.ts",
      path: "apps/viewer/src/model-validation.ts",
      language: "typescript",
      metrics: {
        sloc: 132,
        decisionLoad: 17,
        maximumComplexity: 6,
        executableUnitCount: 12,
      },
      risk: "moderate",
      semanticGroupId: "group:analysis",
      position: { x: -6.5, y: 4.5, z: -2.5 },
      size: { x: 3, y: 7, z: 3 },
    },
    {
      id: "building:demo-model",
      repositoryId: "repository:demo",
      moduleId: "module:viewer",
      districtId: "district:viewer",
      name: "demo-model.ts",
      path: "apps/viewer/src/demo-model.ts",
      language: "typescript",
      metrics: {
        sloc: 86,
        decisionLoad: 0,
    ...
    },
    {
      ...
      risk: "low",
      semanticGroupId: "group:contract",
      position: { x: 7, y: 4, z: -1.8 },
      size: { x: 4, y: 6, z: 4 },
    },
    {
      id: "building:schema",
      ...
      risk: "low",
      semanticGroupId: "group:contract",
      position: { x: 11.5, y: 5, z: 1.8 },
      size: { x: 3, y: 8, z: 4 },
    },
  ],
  dependencies: [
    {
      id: "dependency:main-model",
      repositoryId: "repository:demo",
    ...
    {
      id: "dependency:viewer-core-project",
      repositoryId: "repository:demo",
    ...
    {
      id: "dependency:viewer-three-package",
      repositoryId: "repository:demo",
      sourceId: "module:viewer",
